                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                                ...
                                                <table width="60%"  class="cont tr_color">
                                                    ...
                                                    <%--把之前放在application里的所有的types拿出来
                                                    每拿一次就放在t对象中，所以每一个t就相当于一个type对象
                                                    --%>
                                                    <c:forEach items="${types}" var="t">
                                                        <tr align="center" class="d">
                                                            <td>${t.id}</td> <!--编号-->
                                                            <td>${t.name}</td> <!--名字-->
                                                            <td>${t.parentId}</td> <!--副编号-->
                                                            <td>
                        ...
                        <tr>
                            ...
                            <td width="51%" class="left_txt">
                                <img src="./Images/icon_mail.gif" width="16" height="11"> 客户服务邮箱：1418511087@qq.com<br />
                            </td>
                            <td>&nbsp;</td><td>&nbsp;</td>
                        </tr>
                    </table>
